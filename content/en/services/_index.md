...
- Guided experimental sessions
- Best-practice documentation

> Not all services imply **direct user operation**.  
> The access scheme is defined case by case.

---

## How to request a service

Service requests should include the following information:
...
Priority is generally assigned as follows:
1. Internal academic projects  
2. Undergraduate and graduate theses  
3. External scientific collaborations  
4. Selected technology-oriented projects  
